...
use self::health::{HealthState, InfMode, VaccineState};
...
mod health {
    ...
    impl VaccineState {
        ...
        pub fn insert_param(&mut self, param: VaccinationParam) {
    ...
    impl AgentHealth {
        ...
        pub fn get_state_mut(&mut self) -> &mut HealthState {
            &mut self.state
        }
        ...
        pub fn update(&mut self) -> Option<(HealthDiff, HealthState)> {
